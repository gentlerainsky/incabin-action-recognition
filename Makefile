build:
	docker -l debug build -t local/uniscope3d .

shell:
	docker run --shm-size 16G --gpus all -it -p 8888:8888 -p 6006:6006 -v /media/tk/data_ext:/root/synthetic_cabin_1m -v /data2:/root/data -v .:/workspace local/uniscope3d
