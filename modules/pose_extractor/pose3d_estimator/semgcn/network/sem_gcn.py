...
from modules.pose_extractor.pose3d_estimator.semgcn.network.sem_graph_conv import SemGraphConv
from modules.pose_extractor.pose3d_estimator.semgcn.network.graph_non_local import GraphNonLocal
