...
from modules.action_recognizer.models.pose_transformer.network.pose_transformer import PoseTransformer
...
class LitPoseTransformer(pl.LightningModule):
    ...
    def __init__(self, model_kwargs, lr, is_pose_3d=False, use_bone=False, use_velocity=False):
        ...
        self.model = PoseTransformer(**model_kwargs)
        self.val_predict = []
        self.val_gt = []
        self.test_predict = []
        self.test_gt = []
    ...
    def training_step(self, batch, batch_idx):
        ...
        x = pose.reshape([num_batches, -1, num_channels])
